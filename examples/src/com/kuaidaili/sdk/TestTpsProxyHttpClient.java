...
public class TestTpsProxyHttpClient {

    private static String pageUrl = "http://dev.kuaidaili.com/testproxy"; //要访问的目标网页
    private static String proxyIp = "xxxxx"; //隧道代理host
    private static int proxyPort = xxxx; //隧道代理IP
    private static String username = "xxx"; //隧道id
